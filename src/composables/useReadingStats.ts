...
const UI_SETTINGS_KEYS = [
  ...
  'bookshelf_progress_prefetch_limit',
...
function buildRuntimeSettingsMap(settingsMap: Record<string, string>, settings: ReturnType<typeof useSettings>): Record<string, string> {
  return {
    ...
    bookshelf_progress_prefetch_limit: String(settings.bookshelfProgressPrefetchLimit.value),
    ...
    reader_marginTop: String(settings.marginTop.value),
    reader_marginBottom: String(settings.marginBottom.value),
    ...
    hud_top_margin: String(settings.hudTopMargin.value),
    hud_bottom_margin: String(settings.hudBottomMargin.value),
